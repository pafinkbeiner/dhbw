...
namespace Client.FleetServiceReference {
    ...
    public interface IFleetService {
        ...
        bool ChangeVehicle(Client.FleetServiceReference.Vehicle oldVehicle, Client.FleetServiceReference.Employee newVehicle);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IFleetService/ChangeVehicle", ReplyAction="http://tempuri.org/IFleetService/ChangeVehicleResponse")]
        System.Threading.Tasks.Task<bool> ChangeVehicleAsync(Client.FleetServiceReference.Vehicle oldVehicle, Client.FleetServiceReference.Employee newVehicle);
    }
    ...
    public partial class FleetServiceClient : System.ServiceModel.ClientBase<Client.FleetServiceReference.IFleetService>, Client.FleetServiceReference.IFleetService {
        ...
        public bool ChangeVehicle(Client.FleetServiceReference.Vehicle oldVehicle, Client.FleetServiceReference.Employee newVehicle) {
            return base.Channel.ChangeVehicle(oldVehicle, newVehicle);
        }
        
        public System.Threading.Tasks.Task<bool> ChangeVehicleAsync(Client.FleetServiceReference.Vehicle oldVehicle, Client.FleetServiceReference.Employee newVehicle) {
